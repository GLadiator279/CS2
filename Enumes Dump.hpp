// Output format: [pragma region module name: [enum name : enum type name [field name = field value]]]

#pragma region schemasystem.dll
...
#pragma region resourcesystem.dll
...
#pragma region rendersystemdx11.dll

enum RenderSlotType_t : std::uint32_t {
...
enum InputLayoutVariation_t : std::uint32_t {
...
enum RenderMultisampleType_t : std::uint32_t {
...
#pragma region engine2.dll

enum SpawnDebugOverrideState_t : std::uint32_t {
  SPAWN_DEBUG_OVERRIDE_NONE = 0,
  SPAWN_DEBUG_OVERRIDE_FORCE_ENABLED = 1,
  SPAWN_DEBUG_OVERRIDE_FORCE_DISABLED = 2,
};

enum SpawnDebugRestrictionOverrideState_t : std::uint32_t {
...
#pragma region materialsystem2.dll
...
enum SolveIKChainAnimNodeSettingSource : std::uint32_t {
...
enum AnimPoseControl : std::uint32_t {
  NoPoseControl = 0,
  AbsolutePoseControl = 1,
  RelativePoseControl = 2,
};

enum FacingMode : std::uint32_t {
  FacingMode_Manual = 0,
  FacingMode_Path = 1,
...
enum AnimVRHandMotionRange_t : std::uint32_t {
  MotionRange_WithController = 0,
  MotionRange_WithoutController = 1,
};

enum AnimVrFingerSplay_t : std::uint32_t {
...
enum AnimVrBoneTransformSource_t : std::uint32_t {
...
enum EAnimValueSource : std::uint32_t {
  Constant = 0,
  Parameter = 1,
};

enum ControlValue : std::uint32_t {
...
enum DampedValueType : std::uint32_t {
  FloatParameter = 0,
  VectorParameter = 1,
};

enum SelectionSource_t : std::uint32_t {
  SelectionSource_Bool = 0,
  SelectionSource_Enum = 1,
};

enum SingleFrameSelection : std::uint32_t {
  FirstFrame = 0,
  LastFrame = 1,
  SpecificFrame = 2,
};

enum Comparison_t : std::uint32_t {
  COMPARISON_EQUALS = 0,
...
enum VPhysXBodyPart_t::VPhysXFlagEnum_t : std::uint32_t {
  FLAG_STATIC = 1,
  FLAG_KINEMATIC = 2,
  FLAG_JOINT = 4,
  FLAG_MASS = 8,
...
enum VPhysXConstraintParams_t::EnumFlags0_t : std::uint32_t {
...
enum VPhysXJoint_t::Flags_t : std::uint32_t {
  JOINT_FLAGS_NONE = 0,
  JOINT_FLAGS_BODY1_FIXED = 1,
};

enum VPhysXAggregateData_t::VPhysXFlagEnum_t : std::uint32_t {
...
enum ModelSkeletonData_t::BoneFlags_t : std::uint32_t {
...
enum PermModelInfo_t::FlagEnum : std::uint32_t {
  FLAG_TRANSLUCENT = 1,
...
enum AnimVRHand_t : std::uint32_t {
  AnimVRHand_Left = 0,
  AnimVRHand_Right = 1,
};

enum AnimVRFinger_t : std::uint32_t {
...
#pragma region worldrenderer.dll
...
enum PulseCursorFlow_t : std::uint32_t {
...
#pragma region panorama.dll

#pragma region server.dll
...
enum CommandExecMode_t : std::uint32_t {
  EXEC_MANUAL = 0,
  EXEC_LEVELSTART = 1,
  EXEC_PERIODIC = 2,
  EXEC_MODES_COUNT = 3,
...
enum CommandEntitySpecType_t : std::uint32_t {
  SPEC_SEARCH = 0,
  SPEC_TYPES_COUNT = 1,
};
...
enum BaseActivity_t : std::uint32_t {
  ACT_RESET = 0,
  ACT_IDLE = 1,
  ACT_TRANSITION = 2,
  ACT_COVER = 3,
...
enum TakeDamageFlags_t : std::uint32_t {
  DFLAG_NONE = 0,
...
enum IChoreoServices::ScriptState_t : std::uint32_t {
  SCRIPT_PLAYING = 0,
  SCRIPT_WAIT = 1,
  SCRIPT_POST_IDLE = 2,
  SCRIPT_CLEANUP = 3,
...
enum IChoreoServices::ChoreoState_t : std::uint32_t {
  STATE_PRE_SCRIPT = 0,
...
enum CRR_Response::ResponseEnum_t : std::uint32_t {
...
enum ScriptedMoveType_t : std::uint32_t {
...
enum CLogicBranchList::LogicBranchListenerLastState_t : std::uint32_t {
...
enum SimpleConstraintSoundProfile::SimpleConstraintsSoundProfileKeypoints_t : std::uint32_t {
  kMIN_THRESHOLD = 0,
  kMIN_FULL = 1,
  kHIGHWATER = 2,
};

enum SoundFlags_t : std::uint32_t {
  SOUND_NONE = 0,
  SOUND_COMBAT = 1,
  SOUND_WORLD = 2,
  SOUND_PLAYER = 4,
...
enum ShatterPanelMode : std::uint8_t {
  SHATTER_GLASS = 0,
  SHATTER_DRYWALL = 1,
};
...
enum WorldTextAttachmentType_t : std::uint32_t {
  ATTACHED_NONE = 0,
  ATTACHED_ENTITY = 1,
...
enum SpawnPointCoopEnemy::BotDefaultBehavior_t : std::uint32_t {
  DEFEND_AREA = 0,
  HUNT = 1,
  CHARGE_ENEMY = 2,
...
enum RelativeDamagedDirection_t : std::uint32_t {
  DAMAGED_DIR_NONE = 0,
  DAMAGED_DIR_FRONT = 1,
  DAMAGED_DIR_BACK = 2,
  DAMAGED_DIR_LEFT = 3,
...
enum QuestProgress::Reason : std::uint32_t {
...
enum loadout_positions_t : std::uint32_t {
  LOADOUT_POSITION_INVALID = 18446744073709551615,
...
enum PlayerAnimEvent_t : std::uint32_t {
...
enum ESurvivalSpawnTileState : std::uint8_t {
...
enum ESurvivalGameRuleDecision_t : std::uint32_t {
...
enum SpawnStage_t : std::uint32_t {
  SPAWN_STAGE_NONE = 0,
...
enum EGrenadeThrowState : std::uint32_t {
  NotThrowing = 0,
  Throwing = 1,
  ThrowComplete = 2,
};

enum tablet_skin_state_t : std::uint8_t {
...
enum C_BaseCombatCharacter::WaterWakeMode_t : std::uint32_t {
  WATER_WAKE_NONE = 0,
  WATER_WAKE_IDLE = 1,
